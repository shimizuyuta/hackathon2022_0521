      ...
      <Grid container direction="column" >
        <Box sx={{ mx:3, py:1 }}>
          ...
          <TextField 
            ...
            fullWidth 
            variant="outlined" 
            placeholder="例）サポーターズ主催ハッカソンメンバー募集！"
            value={post.title}
        ...
        <Box sx={{ mx:3, py:1, pb:4 }}>
          ...
          <TextField 
            fullWidth
            id="fullWidth"
            placeholder="例）6月18,19日に開催されるサポーターズ主催のハッカソンのメンバー募集中です！！
            今のところフロント2人、サーバーサイド1人を担当するメンバーがいるので、サーバーサイドを担当してくれる方を募集してます。
            私たちチームのレベル感としては、趣味でアプリ開発をしたことがあるレベルなので初心者大歓迎です😊
            今回のハッカソンでは2人が初出場ということなので、完走できることが目標です。
            是非興味のある方は twitterにてDMお待ちしております。
            twitter →　https://twitter.com/kaepon1219
            "
            minRows='4'
            maxRows='8'
            multiline  
