...
func StartAt(v time.Time) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
...
func EndAt(v time.Time) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
...
func StartAtEQ(v time.Time) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldStartAt), v))
	})
}
...
func StartAtNEQ(v time.Time) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
...
func StartAtIn(vs ...time.Time) predicate.Post {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func StartAtNotIn(vs ...time.Time) predicate.Post {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func StartAtGT(v time.Time) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
...
func StartAtGTE(v time.Time) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
...
func StartAtLT(v time.Time) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
...
func StartAtLTE(v time.Time) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
...
func EndAtEQ(v time.Time) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldEndAt), v))
	})
}
...
func EndAtNEQ(v time.Time) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
...
func EndAtIn(vs ...time.Time) predicate.Post {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func EndAtNotIn(vs ...time.Time) predicate.Post {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func EndAtGT(v time.Time) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
...
func EndAtGTE(v time.Time) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
...
func EndAtLT(v time.Time) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
...
func EndAtLTE(v time.Time) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
